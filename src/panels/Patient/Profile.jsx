                    ...
                    >
                     ...
                     >
                       <div className="flex items-center justify-between mb-5">
                         <h3 className="text-gray-900 font-semibold text-base sm:text-lg flex items-center gap-3">
                           <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#FFF8F8] to-[#E9DFC3]/20 flex items-center justify-center">
                             <FaAllergies className="text-[#0118D8] w-5 h-5" />
                           </div>
                           Known Allergies
                         </h3>
                         <button
                       ...
                       <div className="flex flex-wrap gap-2 sm:gap-3">
                         {patient.allergies.map((allergy, index) => (
                           <span
                             key={index}
                             className="px-4 py-2 bg-[#FFF8F8] text-[#0118D8] rounded-xl border border-[#E9DFC3]/50 flex items-center gap-2 text-sm font-medium hover:bg-[#E9DFC3]/20 transition-colors cursor-default"
                           >
      ...
      {showEditModal && (
        ...
        >
          ...
          >
            ...
            {/* Modal Form */}
            <form onSubmit={(e) => { e.preventDefault(); saveProfile(); }} className="p-6 space-y-6">
          ...
          >
             ...
             >
               <div className="flex items-center gap-3">
                 <div className="w-10 h-10 rounded-lg flex items-center justify-center"
                      style={{ background: '#0F1ED115' }}>
                   <FaAllergies className="w-5 h-5" style={{ color: '#0F1ED1' }} />
                 </div>
                 <div>
                   <h3 className="text-xl font-semibold" style={{ color: '#111827' }}>
                     Edit Allergies
          ...
          >
            ...
            >
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg flex items-center justify-center"
                     style={{ background: '#0F1ED115' }}>
                  <FaStethoscope className="w-5 h-5" style={{ color: '#0F1ED1' }} />
                </div>
                <div>
                  <h3 className="text-xl font-semibold" style={{ color: '#111827' }}>
