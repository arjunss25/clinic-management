            ...
            <div className="border-b pb-4">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-gray-600">General Checkup • Dr. Sarah Wilson</p>
                  <p className="text-sm text-gray-500">Age: 35 • Male</p>
                </div>
                <div className="text-right">
                  <p className="text-blue-600 font-semibold">09:00 AM</p>
                  <p className="text-sm text-gray-500">Today</p>
                  <button className="mt-2 text-white bg-blue-600 px-4 py-1 rounded hover:bg-blue-700">
                    Check In
                  </button>
                </div>
              </div>
            ...
            <div className="border-b pb-4">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-gray-600">Follow-up • Dr. Michael Brown</p>
            ...
            <div className="pb-4">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-gray-600">Consultation • Dr. Emily Davis</p>
