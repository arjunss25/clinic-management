            ...
            >
              <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 sm:gap-6">
                ...
                <div className="flex gap-2 sm:gap-3 w-full sm:w-auto justify-end">
                  <button
                    onClick={() =>
                      navigate(`/doctor/patient-booking/${patient.id}`, {
                        state: { patient },
                      })
                    }
                  ...
                  <button className="flex-1 sm:flex-none group px-3 sm:px-4 py-1.5 sm:py-2 bg-[#FFF8F8] text-[#0118D8] rounded-lg font-medium hover:bg-[#E9DFC3] transition-all duration-300 flex items-center justify-center gap-1.5 border border-[#E9DFC3] text-sm">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <p className="text-gray-600 text-sm">Policy: {patient.policyNumber}</p>
                      </motion.div>
                      ...
                      >
                        ...
                        <p className="text-gray-600 text-sm">{patient.emergencyContact.name} ({patient.emergencyContact.relation})</p>
                        <p className="text-gray-600 text-sm">{patient.emergencyContact.phone}</p>
                      </motion.div>
                    </motion.div>
                  </motion.div>
                )}
